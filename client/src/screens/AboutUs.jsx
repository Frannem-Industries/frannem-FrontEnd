...
import SEO from "../components/SEO/SEO"; // Updated import path to match our SEO component
...
const AboutUs = () => {
  ...
  return (
    <>
      ...
      <SEO
        title="About Us"
        description="Franemm Industries Limited is a multinational and continental consumer home care, cosmetics, food and nutritional production company. Learn about our mission, vision, and journey."
        image={about}
        url="/about"
        canonicalUrl="/about"
      />
