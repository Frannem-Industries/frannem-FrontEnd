...
const Blog = () => {
  ...
  // Get featured blog for meta image if available
  const featuredBlog = filteredBlogs.length > 0 ? filteredBlogs[0] : null;
  const metaImage = featuredBlog?.coverImageUrl || null;

  // Create a description from the featured blog if available
  const getMetaDescription = () => {
    if (!featuredBlog)
      return "Discover beauty secrets, product insights, and expert tips to enhance your self-care routine on our blog.";

    if (featuredBlog.body && featuredBlog.body[0]?.children?.[0]?.text) {
      const text = featuredBlog.body[0].children[0].text;
      ...
      <div className='min-h-screen bg-gradient-to-b from-gray-50 to-white pt-12 pb-20'>
        ...
        >
          ...
          >
            ...
            >
              Discover beauty secrets, product insights, and expert tips to
                  ...
                  <div className='relative overflow-hidden rounded-2xl shadow-2xl group'>
                    ...
                    >
                      <div className='flex items-center mb-4'>
                        ...
                        <span className='text-white/80 text-sm'>
                          {filteredBlogs[0].publishedAt
                            ? format(
                                new Date(filteredBlogs[0].publishedAt),
                                "MMMM dd, yyyy"
                              )
                            : "Recently Published"}
                        </span>
                      ...
                      <p className='text-white/90 mb-6 max-w-2xl line-clamp-2 md:line-clamp-3'>
                        {(filteredBlogs[0].body &&
                          filteredBlogs[0].body[0]?.children?.[0]?.text) ||
                ...
                <div className='relative z-10 flex flex-col md:flex-row items-center justify-between gap-8'>
                  <div className='md:max-w-md'>
                    ...
                    <motion.p
                      ...
                      viewport={{ once: true }}
                    >
                      Get the latest beauty tips, product updates, and
            ...
            >
              ...
              >
                <Icon
                  ...
                  className='text-7xl text-gray-300 mx-auto'
                />
              </motion.div>
              ...
              >
                ...
                <div className='p-6 overflow-y-auto'>
                  ...
                  <div className='text-gray-600 mb-6 line-clamp-6'>
                    {(selectedBlog.body &&
                      selectedBlog.body[0]?.children?.[0]?.text) ||
